...
describe('AMM', () => {
  ...
  describe('Swapping tokens', () => {
    ...
    it('facilitates swaps', async () => {
      ...
      // Estimate tokens to receive after swappint token1: include slippage
      ...
      balance = await token1.balanceOf(liquidityProvider.address)
      console.log(`Liquidity provide token1 balance after removing funds ${ethers.utils.formatEther(balance)} \n`)
