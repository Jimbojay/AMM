...
contract AMM {
    ...
    //Determine how many token2 tokens must be desposited when depositing liquidity for token1
    ...
    //Determine how many token1 tokens must be desposited when depositing liquidity for token2
    ...
    // Retuns the amount of token2 received when sapping token1
        ...
        returns(uint256 token2Amount) 
    {
        ...
        //Do swap
        //1. Transfer token 1 tokens out o user wallet
        token1.transferFrom(msg.sender, address(this), _token1Amount);
